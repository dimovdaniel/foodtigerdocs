...
* Accept terms on register
* Multi language picker on the landing page
...
* 3.0.6 - 3.0.3, 3.0.4, 3.0.5 + Driver notification fix [Files](https://paste.laravel.io/0e424692-add2-4822-bc1f-52559fbbdbbf)
* 3.0.5 - POS fixes [Files](https://paste.laravel.io/06b893a6-ebee-41cd-b586-a30b8d46d0db)
* 3.0.4 - 3.0.3+ Small fixes + Cities API fix. Error was made in the zipping of the update in 3.0.3 [Files](https://paste.laravel.io/8563ed64-4b02-4629-87ae-65a0480c145a)
* 3.0.3 - Remove apps, Recaptcha on all forms, Logo custom css - file changed is config/config.php
...
{% embed url="https://youtu.be/tvwLPyzpqP4" %}
...
* 2.7.5 - Small security update [Information](https://www.reddit.com/r/mobidoniacc/comments/qdrf13/275\_security\_update/) [Updated files](https://paste.laravel.io/d8fbbf22-e8a8-4504-8c64-a58fd21fe9a1)
...
* [Expenses](https://mobidonia.gumroad.com/?sort=page\_layout#NwxgX)
* [All-Access Pass](https://mobidonia.gumroad.com/?sort=page\_layout#PVVGE) ( All plugins free, apps on 50% )
* [Cloner](https://mobidonia.gumroad.com/?sort=page\_layout#pVCjei)
...
{% embed url="https://youtu.be/c0W9cfGkba4" %}
...
{% embed url="https://youtu.be/-NVglUwHHrA" %}
...
{% embed url="https://youtu.be/fkZZHYLLems" %}
...
[Here](../define-basics/google-api.md) you can check updated version for enabling Geocoding API based on the previous used APIs
